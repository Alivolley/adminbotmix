               ...
               <Grid item xs={12} md={6}>
                  <div className="space-y-[25px]">
                     <HowWeWorkCard imageSrc={robotTest} step="ربات تکنیکال">
                        بدون نیاز به هیچ پلتفرم دیگری و فقط همینجا ، رربات خودت رو انتخاب کن و به صرافی خودت متصل کن تا
                     ...
                     <HowWeWorkCard imageSrc={codeTest} step="برنامه نویسی">
                        ما اینجا متخصصینین در زمینه برنامه نویسی و بازار های مالی داریم که میتونن استراتژی شخصی شما رو
                        تبدیل به ربات تریدر کرده تا ربات تریدر یا دستایر شخصی خودتون رو داشته باشید
                     </HowWeWorkCard>
                  </div>
               </Grid>
               <Grid item xs={12} md={6}>
