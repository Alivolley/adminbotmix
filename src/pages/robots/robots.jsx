...
function Robots() {
   ...
   } = useSpecificRobot(robotId, setDefaultId);
   const {
   ...
   return (
      <div>
         {robotsListIsLoading ? (
                        ...
                        <CardWrapper className="flex h-full items-center justify-center">
                           {robotsSpecificIsLoading ? (
                              ...
                              <div className="w-full">
                                 {robotsSpecificData?.chart?.length && (
            ...
            <CardWrapper>
               <p className="text-center text-lg font-bold">شما هیچ رباتی ندارید</p>
            </CardWrapper>
         )}
      </div>
   );
