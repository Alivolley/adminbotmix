            ...
            <div>
              ...
              <div className="space-y-10 text-sm leading-[30px] customSm:text-base">
                <p>
                  ...
                  سادگی نامفهوم استفاده از طراحان گرافیک است در ستون سادگی سادگی
                  نامفهوم استفاده از طراحان گرافیک است در ستون سادگی سادگی
                  نامفهوم استفاده از طراحان گرافیک است در ستون سادگی نامفهوم و
                  تولید سادگی نامفهوم از صنعت چاپ و با سادگی نامفهوم استفاده از
          ...
          <Grid item xs={12} md={3.5}>
            <div className="border-r border-gray-300 pr-5 dark:border-gray-600">
              ...
              <Link to="/articles" className="mt-12 flex justify-center">
                <LinkComponent className="px-5 customSm:px-10">
                  مشاهده همه مقاله ها
                </LinkComponent>
              </Link>
            </div>
